...
The county layer contains 2020 Feeding America Map the Meal Gap modeled estimates, served by the federal Health Resources and Services Administration (HRSA). Newer statewide context comes from the 2024 California Health Interview Survey and 2025 findings shared by California Food Banks. These measures use different populations and methods and should not be compared directly.
